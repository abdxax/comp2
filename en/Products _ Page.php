                        ...
                        <img src="../'.$pr['path'].'" alt="" width="10px" height="150px">
                            ...
                            <div class="bar" style="width: 500px;"><span></span></div>			
                                <div class="label" style="left: 498px;"><span></span><div class="perc">'.$pr['proc'].'%</div></div>		
                                        ...
                                        <div class="kode_project_dollar">	<a href="detlprod.php?id='.$pr['id'].'">From : <span>'.$pr['froms'].'</span></a>	<a href="detlprod.php?id='.$pr['id'].'"> To : <span>'.$pr['tos'].'</span></a></div><p></p><div class="kode_project_share">	<a class="medium_btn background-bg-dark btn_hover" href="detlprod.php?id='.$pr['id'].'"> Show Details</a>	<div class="kode_social_share">		<a href="http://www.arat.sa/Products.aspx#"><i class="fa fa-share-alt"></i>Shair :</a>		<ul class="social_meta">			<li><a class="hvr-ripple-out" href="http://www.arat.sa/Products.aspx#"><i class="fa fa-facebook"></i></a></li>			<li><a class="hvr-ripple-out" href="http://www.arat.sa/Products.aspx#"><i class="fa fa-twitter"></i></a></li>			<li><a class="hvr-ripple-out" href="http://www.arat.sa/Products.aspx#"><i class="fa fa-tumblr"></i></a></li>		</ul>	</div></div>		</div>	</div>
