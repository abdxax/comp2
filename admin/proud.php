...
if($file_size>0){
 if($file_size<=900000){
     ...
     $enname=strip_tags($_POST['pronameen']);

     $path="../upload/";

     if(move_uploaded_file($file_tem,$path.$file_name)){
         $path2="upload/".$file_name;
        $admin-> AddNewpro($name,$price,$path2,$from,$tos,$pr,$enname);
        //$msg;
     }
...
?>
              <div class="col-8 ">
                  <form method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                          <div class="col-7">
                              <input type="text" name="pronameen" class="form-control" placeholder=" اسم المنتج بالانجليزي" >
                          </div>
                      </div>
