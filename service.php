						...
						<div class="row">
                            ...
                            foreach($serv as $sar){
                                ...
                                <div class="kode_service_text">
                                    <h3 dir="rtl"><a href=""><a href="detlserv.php?id='.$sar['id'].'">'.$sar['name'].'</a></h3>	<p></p>
                                    </div>
                                    </div>
                                    	</div>
                                ';
					...
					<div class="widget_copyright">
						...
						<div class="container">
							<div class="copyright_text">
								<p>حقوق المحتوى محفوظة  © 2020. لشركة الرؤى الثاقبة <a href="http://www.arat.sa/service.aspx#"> arat.sa</a></p>
								<a id="child-topbtn" class="top_btn hvr-bob" href="http://www.arat.sa/service.aspx#"><i class="fa fa-long-arrow-up" aria-hidden="true"></i></a>
							</div>
						</div>
						<!--CONTAINER END-->
					</div>
